...
namespace OOP_lab4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            imitate_loading("Asteroid exploration....");
            Console.WriteLine("..exploration finished");
            asteroid1.Legend = "Impact - zero probability. Suitable for ore mining"; //позже можно доработать: данное поле изменяется обектом класса - SpaceProbe
            Console.WriteLine(asteroid1);
